...
@Component({
  selector: 'app-daftar-banding-gugatan-list',
  templateUrl: './daftar-banding-gugatan-list.component.html',
  styleUrls: ['./daftar-banding-gugatan-list.component.css'],
  providers: [DaftarBandingGugatanService]
})
export class DaftarBandingGugatanListComponent implements OnInit {
  items         : Permohonan[];
  ...
  /**
     ...
     */
    prepareTableContent() {
      this._service.getAllDaftarSidang().subscribe(result => {
          this.items = result;
        ...
        this.dialogsService
          ...
          .subscribe(accept => {
            if (accept) {
              ...
              this._service.getDaftarCetakBG(this.daftarCetak).subscribe(result => {
