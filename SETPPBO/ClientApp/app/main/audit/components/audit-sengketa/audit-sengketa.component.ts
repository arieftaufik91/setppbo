...
import { AuditSengketaDetailComponent } from '../audit-sengketa-detail/audit-sengketa-detail.component';
...
@Component({
    selector: 'audit-sengketa',
    templateUrl: './audit-sengketa.component.html',
    styleUrls: ['./audit-sengketa.component.css'],
...
export class AuditSengketaComponent implements OnInit {
    // default properties
    items: AuditSengketaList[];
    tempItems: AuditSengketaList[];
    item: AuditSengketaList;
    ...
    onViewClick() {
        ...
        let dialogRef = this.dialog.open(AuditSengketaDetailComponent, {
