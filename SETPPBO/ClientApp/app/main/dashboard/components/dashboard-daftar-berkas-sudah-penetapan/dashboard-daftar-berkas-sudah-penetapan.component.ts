...
@Component({
  selector: 'app-dashboard-daftar-berkas-sudah-penetapan',
  templateUrl: './dashboard-daftar-berkas-sudah-penetapan.component.html',
  styleUrls: ['./dashboard-daftar-berkas-sudah-penetapan.component.css']
})
export class DashboardDaftarBerkasSudahPenetapanComponent implements OnInit {
  ...
  prepareTableContent() {
    this._service.getDaftarBerkasSudahPenetapan().subscribe(result => {
      this.items = result;
