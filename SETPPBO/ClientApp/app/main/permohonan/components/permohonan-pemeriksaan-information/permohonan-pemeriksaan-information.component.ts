...
@Component({
    selector: 'app-permohonan-pemeriksaan-information',
    templateUrl: './permohonan-pemeriksaan-information.component.html',
    styleUrls: ['./permohonan-pemeriksaan-information.component.css'],
    providers: [PermohonanService, KelengkapanService]

})
export class PermohonanPemeriksaanInformationComponent implements OnInit {
    model: Permohonan;
    formGroup: FormGroup;
    constructor(
