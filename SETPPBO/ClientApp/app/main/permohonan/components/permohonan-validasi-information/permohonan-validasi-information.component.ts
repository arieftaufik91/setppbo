...
@Component({
  selector: 'app-permohonan-validasi-information',
  templateUrl: './permohonan-validasi-information.component.html',
  styleUrls: ['./permohonan-validasi-information.component.css'],
  providers: [PermohonanService, KelengkapanService]
})
export class PermohonanValidasiInformationComponent implements OnInit {
    model: Permohonan;
    formGroup: FormGroup;
    constructor(
