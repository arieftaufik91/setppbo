...
import { RefJenisPenomoranFormComponent } from '../ref-jenis-penomoran-form/ref-jenis-penomoran-form.component';
...
@Component({
  selector: 'app-ref-jenis-penomoran',
  templateUrl: './ref-jenis-penomoran.component.html',
  styleUrls: ['./ref-jenis-penomoran.component.css'],
...
export class RefJenisPenomoranComponent implements OnInit {
  // default properties
  items: RefJenisPenomoran[];
  tempItems: RefJenisPenomoran[];
  item: RefJenisPenomoran;
  ...
  ngOnInit() {
    this.prepareTableContent();
        ...
        this.columns = [
            ...
            { name: "Uraian",  prop: "Uraian" },
            { name: "Prefix",  prop: "Prefix" },
  ...
  onAddClick() {
      // add new alasan
      //dialog form
      let dialogRef = this.dialog.open(RefJenisPenomoranFormComponent, {});
