...
import { RefnormawaktuService } from "../../services/referensi-normaWaktu.service";
...
import { RefnormawaktuFormComponent } from '../referensi-normaWaktu-form/referensi-normaWaktu-form.component';


@Component({
  selector: 'app-referensi-normaWaktu',
  templateUrl: './referensi-normaWaktu.component.html',
  styleUrls: ['./referensi-normaWaktu.component.css',
],
...
export class RefnormawaktuComponent implements OnInit {
  items: Refnormawaktu[];
  tempItems: Refnormawaktu[];
  item: Refnormawaktu;
  ...
  state = "inactive";
  constructor(
    private _service: RefnormawaktuService,
  ...
  ngOnInit() {
    ...
    this.columns = [{ prop: "RefNormaWaktuId" }, {prop: "RefJenisPermohonan.Uraian"}, {prop:"RefJenisNormaWaktu.Uraian"}, {prop:"Bulan"}, {prop:"Hari"}];
  }
  ...
  onAddClick() {
    // add new quote
    //dialog form
    let dialogRef = this.dialog.open(RefnormawaktuFormComponent, {});
